...
require (
	github.com/bots-go-framework/bots-api-telegram v0.15.18
	github.com/bots-go-framework/bots-fw v0.77.9
	github.com/bots-go-framework/bots-fw-store v0.14.1
	github.com/bots-go-framework/bots-fw-telegram-models v0.3.80
...
require (
	...
	github.com/strongo/strongoapp v0.31.53 // indirect
